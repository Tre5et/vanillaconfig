...
public class GuiBaseWidget {
    ...
    public boolean render(GuiGraphicsExtractor context, int index, int mouseX, int mouseY, int scrollOffset) { return false; }
    public boolean render(GuiGraphicsExtractor context, int mouseX, int mouseY, int scrollOffset) {
