...
public class ExampleConfig implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ButtonConfig button1 = new ButtonConfig("bbbbuuuuuu1111", "button1.comment", false, true, true);
        button1.onClickL(ExampleConfig::onButtonClickedL);
        button1.onClickR(ExampleConfig::onButtonClickedR);
        ...
        bool6 = boolean6;
        bool7 = boolean7;
        boolean1.onChange(ExampleConfig::onBoolean1Switched);
        boolean5.onChange(ExampleConfig::onBoolean5Switched);
        ...
        config.onLoad(ExampleConfig::onLoad);
        config.onSave(ExampleConfig::onSave);
        page1.onLoadPerWorld(ExampleConfig::onLoadWorld);
        page1.onSavePerWorld(ExampleConfig::onSaveWorld);
        ...
        openConfig.onPressed(ExampleConfig::resolveKey);
    }
    ...
    public static void onBoolean1Switched(boolean prevValue, String key) {
        for(BaseConfig e : bigConfig.getOptions()) {
            if(e.getKey().equals(bool1.getKey())) continue;
            e.setDisplayed(!prevValue);
        }
    }
